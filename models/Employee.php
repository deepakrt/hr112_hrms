...
class Employee extends \yii\db\ActiveRecord{
    ...
    {
        return [
            [['employee_id', 'fname', 'gender','dob', 'phone', 'emergency_phone', 'address', 'city', 'state', 'zip', 'contact', 'p_address', 'p_city', 'p_state', 'p_zip', 'joining_date', 'employment_type','desg_id', 'is_active', 'created_date',  'dept_id', 'effected_from'], 'required'],
            ...
            [['emplevel','personal_email','contact2','emp_image', 'emp_signature','gender', 'is_active','address', 'city', 'state', 'zip', 'contact', 'p_address', 'p_city', 'p_state', 'p_zip', 'p_contact'], 'string', 'max' => 255],
