...
//                    echo "<pre>";print_r($projects);
                    ...
                    <tr>
                        ...
                        <td><?=$p['status']?></td>
                        <td><a href="<?=$add_cbd?>" title="Add Project BreakDown"><img width='25' src='<?=Yii::$app->homeUrl?>images/details_open.png'></a>&nbsp; &nbsp;<a href="<?=$editUrl?>" title="Edit Project Information"><img src='<?=Yii::$app->homeUrl?>images/edit.gif'></a>&nbsp; &nbsp;<a href="<?=$editUrl.'&view=1';?>" class=""><img width='25' src='<?=Yii::$app->homeUrl?>images/vieww.png'></a></td>
