...
//                    echo "<pre>";print_r($projects);
                    ...
                    if(!empty($projects)){
                        ...
                        foreach($projects as $p){
                            ...
                            $add_cbd = Yii::$app->homeUrl."manageproject/projects/addprojectdetails?securekey=$menuid&key=$Prid&key1=$status";
                    ?>
                    <tr>
                        <td><?=$i?></td>
                        ...
                        <td><?=$p['status']?></td>
                        <td><a href="<?=$add_cbd?>" title="Add Details"><img width='25' src='<?=Yii::$app->homeUrl?>images/details_open.png'></a>&nbsp; &nbsp;<a href="<?=$editUrl?>" title="Edit"><img src='<?=Yii::$app->homeUrl?>images/edit.gif'></a>&nbsp; &nbsp;<a title="View " href="<?=$editUrl.'&view=1';?>" class=""><img width='25' src='<?=Yii::$app->homeUrl?>images/vieww.png'></a></td>
