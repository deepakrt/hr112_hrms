...
<div class="container paddtop117">
  ...
  <?php echo \app\components\Sidebarwidget::widget(array('menuid'=>$menuid)); ?> 
     ...
     <div style="margin-top:30px; " class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-heading respantit">
            <h3 class="panel-title"> Update Registration </h3>
          </div>
    ...
    ?> 
            <form enctype="multipart/form-data" method="post" action="<?php echo $homeUrl?>workflow/umsupdateregistrationno/insert" name="frm" id="frm">
              ...
              <div class="col-lg-12 mar10">
               ...
               <div class="col-lg-12 mar10">                
                   <div class="col-lg-2">Department</div>
                    <div class="col-lg-4">
                        <select name="updateregno[deptInfo]" id="Assign_Department" class="CY">
                            <?php
                   ...
                   <div class="col-lg-2">Course</div>
                    <div class="col-lg-4">
                        <select name="updateregno[beCourse]" id="Assign_Course" onchange="getEndBatch()">
            ...
            <div class='input-group date' id='updateregno_yearDIV'>
                <input id="uploadstudent_StartBatch" type="text" readonly="readonly" value="" name="updateregno[StartBatch]">
                <span class="input-group-addon">
                   ...
                   <div class="col-lg-2">End Batch</div>
                    <div class="col-lg-4">
                    <input id="uploadstudent_EndBatch" type="text" readonly="readonly" value="" name="updateregno[EndBatch]">    
                    </div>
                   </div>            
              ...
              <div class="col-lg-12 mar10" style="margin-top: 10px;">
                <div class="col-lg-2"></div>
                <div class="col-lg-5" style="font-weight: 300;"><a href="<?php echo $homeUrl;?>Formats/Update_Registraion_With_RollNo.xlsx">Download Excel Sheet(XLSX) Format</a></div>
              </div>
              
              <div class="col-lg-12 mar10" style="margin-top: 10px;">
                <div class="col-lg-2">Upload Sheet</div>
                <div class="col-lg-4">
                  <input type="file" name="updateregno[fileUpload]" size="40" value="" id="frm_fileUpload">                  
                </div>
              </div>
