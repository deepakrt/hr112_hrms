              ...
              <table class="wwFormTable">
                ...
                <div class="col-lg-12 mar10">
                 <div class="col-lg-2">Subject Type</div>
                  ...
                  <div class="col-lg-4">
                     <select name="beSubject[subjectId]" id="subjectId" onchange="getAssignandUnassignsubject()">
                  ...
                  <div style="display:none" class="hidedepartmentforassignsubject col-lg-12 mar10">
                      <hr>
                     <div class="col-lg-2">Faculty Department</div>
                  <div class="col-lg-4">
                     <select name="beSubject[assign_faculty_department]" id="Assign_Faculty_Department" class="Assign_Faculty_Department">
						<?php
                  ...
                  <div class="col-lg-4">
                     <select name="beSubject[assign_subject_to_faculty]" id="assign_subject_to_faculty" class="assign_subject_to_faculty" >
                ...
                <div class="col-lg-12 mar10">
                  ...
                  ?>
      <input style="display:none" name='insert' class="btn btn-primary assign_subject_to_faculty_btn" type="button" onclick="return validate_AssignSubjectbyhod()" value="Assign Subject" id="assign_subject_to_faculty_btn">
