...
<div class="container paddtop117">
  ...
  <?php echo \app\components\Sidebarwidget::widget(array('menuid'=>$menuid)); ?> 
     ...
     <div style="margin-top:30px; " class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-heading respantit">
            <h3 class="panel-title"> Upload Faculty Details </h3>
          </div>
    ...
    ?> 
            <form enctype="multipart/form-data" method="post" action="<?php echo $homeUrl?>workflow/uploadfacultylist/insert" name="frm" id="frm">
               ...
               <div class="col-lg-12 mar10">                
                   <div class="col-lg-2">Department</div>
                    <div class="col-lg-4">
                        <select name="uploadfaculty[deptInfo]" id="Assign_Department" class="">
                            <?php
                ...
                <div class="col-lg-4">
                  <input type="file" name="uploadfaculty[fileUpload]" size="40" value="" id="frm_fileUpload">                  
                </div>
                </div>
                
              <div class="col-lg-12 mar10" style="margin-top: 10px;">
                <div class="col-lg-4"></div>
                <div class="col-lg-6" style="font-weight: 300;"><a href="<?php echo $homeUrl;?>Formats/Multiple_Faculty_Upload_Format.xlsx">Download Excel Sheet(XLSX) Format</a></div>
              </div>
              ...
              <div class="col-lg-12 mar10">
                  ...
                  <?php
                      ...
                      ?>
                    <input name='insert' class="btn btn-primary" type="submit" onclick="return validateupdatemultiplefaculty()" value="Save" id="">
