    ...
    <div class="row col-sm-12">
       ...
       ?>
        <div class="col-sm-6">
            ...
            <select name="beGroupMaster[deptInfo]" id="department_id" class="CY new_Dept_Select form-control" onchange="actionOnChangeDepartment(this.value)">
                <?php
        ...
        <div class="col-sm-6">
            ...
            <select name="beGroupMaster[beCourse]" id="assign_Course" class="new_Course_Select form-control" onchange="actionOnChangeCoures(this.value)">
        ...
        <div class="col-sm-6">
            ...
            <label for="district_name">Training Program:</label>
            <select name="district_name[beDistrictName]" id="start_end_date_time" class="new_Course_Select form-control" onchange="datetimeonchange(this)">
        ...
        <div class="col-sm-6">
            ...
            <select class="new_Semester_Select PopulateStudent form-control" name="beGroupMaster[semesterId]"  id="trg_venue" onchange="actionOnChangeVanue(this.value)">
        ...
        <div class="col-sm-6">
            ...
            <select name="district_name[beDistrictName]" id="district_name" class="new_Course_Select form-control" onchange="actionOnChangeDist(this.value)">
...
<script type="text/javascript">
    ...
    $('body').on('click','.assign_allstudent_to_group',function()
    {
        ...
        function actionOnChangeCoures(crsID)
        {
            $('#start_date_endate_disp').val('');
            $('#district_name').prop('selectedIndex',0);     
            $('#start_end_date_time').html('<option>Select</option>');   
            ...
            if(department_id != '' && crsID != '')
            {
                startLoader();
                 $.ajax({
                    ...
                    type: 'POST',
                    data: { department_id:department_id,crsID:crsID},
                    dataType: 'JSON',
            ...
            if(department_id != '' && district_name != '' && assign_Course != '')
            {
                startLoader();
                 $.ajax({
                    ...
                    type: 'POST',
                    data: { department_id:department_id,district_name:district_name,assign_Course:assign_Course,start_end_date_time:start_end_date_time },
                    dataType: 'JSON',
                    success: function (data) 
                    {
                        // alert(data);
