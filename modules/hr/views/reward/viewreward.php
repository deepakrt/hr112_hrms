        ...
        <div  id="info">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                   ...
                   // echo "<pre>";print_r($infoDetails);die;
                    
                    
                    $encry = base64_encode($info['id']);
                    $applyUrl = Yii::$app->homeUrl."hr/reward/applyreward?securekey=$menuid&rewardid=$encry";
                    if(!empty($infoDetails)){
                        if ($infoDetails['status']==1) {
                             echo "<b>STATUS: </b> Applied for Reward";
                         }
                        else if ($infoDetails['status']==2) {
                             echo "<b>STATUS: </b> Approved By FLA";
                         }
                         elseif ($infoDetails['status']==3) {
                             echo "<b>STATUS: </b> Approved By SLA";
                         }
                         elseif ($infoDetails['status']==4) {
                             echo "<b>STATUS: </b> Rejected By FLA";
                         }
                         elseif ($infoDetails['status']==5) {
