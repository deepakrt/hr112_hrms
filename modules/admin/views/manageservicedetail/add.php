...
?>
<input type="hidden" name="ser_id"  readonly="" />
<div class="row">
    <div class="col-sm-4">
    ...
    <div class="col-sm-6">
        <div class="row">
            ...
            <div class='col-sm-5'>
                <label><span class="hindishow12">विभाग / </span> Department</label>
        <select class="form-control form-control-sm" onchange="get_dept_emp_lists('service_dept_id', 'service_emp_code')" id="service_dept_id" name='fla_dept_id'>
                    <option value="">Select Department</option>
                    <?php 
                    if(!empty($depts)){
                        foreach($depts as $d){
            ...
            <div class='col-sm-7'>
                ...
                <select class="form-control form-control-sm" id='service_emp_code' name='fla_emp_code' >
    ...
    <div class="col-sm-6">
        <div class="row">
            ...
            <div class='col-sm-5'>
                <label><span class="hindishow12">विभाग / </span> Department</label>
        <select class="form-control form-control-sm" onchange="get_dept_emp_lists('service1_dept_id', 'service1_emp_code')" id="service1_dept_id" name='sla_dept_id' >
                    <option value="">Select Department</option>
                    <?php 
                    if(!empty($depts)){
                        foreach($depts as $d){
            ...
            <div class='col-sm-7'>
                <label><span class="hindishow12">कर्मचारी / </span> Employee</label>
                <select class="form-control form-control-sm" id='service1_emp_code' name='sla_emp_code'  >
                    <option value="">Select Employee</option>
                    <?php
    ...
    <div class="col-sm-12 text-center">
        ...
        <input name="abc"  type="hidden"  value="<?=$info['employee_code']?>" >
