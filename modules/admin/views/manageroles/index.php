...
<div class="row">
    ...
    <div class="col-sm-6"><h6><b>Add New Role</b></h6></div>
    <div class="col-sm-6">
        <a style="float: right;" href="<?=Yii::$app->homeUrl?>admin/manageroles/assign_role?securekey=<?=$menuid?>" class="btn btn-outline-success btn-sm">Click to Assign Role</a>
    </div>
    <div class="col-sm-3">
