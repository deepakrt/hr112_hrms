...
<table id="dataTableShow" class="display" style="width:100%">
    ...
    if(!empty($claims)){
        ...
        foreach($claims as $claim){
            ...
            $viewUrl = Yii::$app->homeUrl."finance/reimbursementclaim/viewsancclaims?securekey=$menuid&opd_id=$opd_id&ec=$employee_code&entitle_id=$entitle_id";
