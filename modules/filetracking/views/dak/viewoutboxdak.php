<?php
$this->title="Outbox : View Dak Details";
...
<input type="hidden" value="<?=Yii::$app->utility->encryptString("O")?>" name="Note[viewtype]" />
...
<div class="row">
    <div class="col-sm-12 text-right">
        ...
        <a target="_blank" href="<?=Yii::$app->homeUrl?>filetracking/dak/downloaddak?securekey=<?=$menuid?>&dak_id=<?=Yii::$app->utility->encryptString($dakDetails['dak_id'])?>" class="btn btn-success btn-sm">Download File with Notes</a>
    </div>
</div>
<?php 
}else{ ?>
...
<!--<div class="col-sm-12 text-right">
    <?php if($dakDetails['access_level'] == 'W'){ ?>
    <a href="javascript:void(0)" id="clickviewnote" class="btn btn-secondary btn-sm">View Notes</a>
    <a target="_blank" href="<?=Yii::$app->homeUrl?>filetracking/dak/downloaddak?securekey=<?=$menuid?>&dak_id=<?=Yii::$app->utility->encryptString($dakDetails['dak_id'])?>" class="btn btn-success btn-sm">Download File with Notes</a>
    <?php  } ?>
    <a target="_blank" href="<?=$fileDownload?>" class="btn btn-success btn-sm">Download File</a>
</div>-->
