...
class ClosedController extends \yii\web\Controller
{
    ...
    public function actionViewoutboxdak()
    {
        ...
        $url = Yii::$app->homeUrl."efile/closed?securekey=$menuid";
...
//			return $this->render('viewoutboxdak', ['menuid'=>$menuid, 'fileinfo'=>$fileinfo, 'movement'=>$movement, 'receiptInfo'=>$receiptInfo]);		
			return $this->render('../outbox/viewoutboxdak', ['menuid'=>$menuid, 'fileinfo'=>$fileinfo,  'receiptInfo'=>$receiptInfo]);		
//			return $this->render('viewcloseddak', ['menuid'=>$menuid, 'fileinfo'=>$fileinfo,  'receiptInfo'=>$receiptInfo]);		
		}else{
