...
<table class="table table-bordered">
    ...
    <tr>
        <td style='width: 50%'><b> क्या इंटरनेशनल डाक है? / Is International Dak? </b></td>
        <td style='width: 50%'><?=Yii::$app->fts_utility->showYesNo($dak_received["is_international"])?></td>
    </tr>
    <tr>
    ...
    <?php 
    if($dak_received["is_international"] == 'N'){
        $org_district=Yii::$app->Dakutility->get_master_districts($dak_received["org_district"],NULL);
    ...
    <tr>
        ...
        <td style="width: 50%"><?=$district.", ".$state?></td>
    </tr>
    <?php  }  ?>
    <tr>
