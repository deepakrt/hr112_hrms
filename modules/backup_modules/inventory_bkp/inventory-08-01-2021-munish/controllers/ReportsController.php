   ...
   public function actionIndex()
    {
        ...
        $sql =" SELECT * FROM `store_item_master` where Quantity!=0 ";
		if(isset($_POST['group_name'])){
			$sql.=" and CLASSIFICATION_CODE=".$_POST['group_name'];
		}
		if(isset($_POST['cat_name'])){
			$sql.=" and ITEM_CAT_CODE=".$_POST['cat_name'];
		}
	...
	public function actionLedger()
    {
		...
		$cat_id=$_POST['cat_name'];
 		$items=Yii::$app->inventory->get_cat_item($cat_id);
		}
	...
	public function actionIrequest()
    {
		...
		//echo "<pre>";print_r($groups);die;
 		$model = new Inventory();
        return $this->render('Irequest', ['model'=>$model,'groups'=>$groups,'category'=>$category,'cost_centre'=>$cost_centre,
										  'unit_master'=>$unit_master,'menuid'=>$menuid]);
    }
