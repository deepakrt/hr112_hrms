...
<form action="" id="reqform" method="post" onsubmit="return false;" >
	 ...
	 <div class="form-group col-sm-12" style="width:100%;">
		...
		<?php if($maindata['flag']=='9' || $maindata['flag']=='12' || $maindata['flag']=='11' || $maindata['flag']=='8'){ ?>
					<td align="left"><b>Approved by StoreInc</b><br><?=date('d-m-Y',strtotime($maindata['storeinc_action_date']));?></td>
				<?php } ?>
		</tr>
		...
		<tr>
			...
			<td align="left"> <b> Approved by Finance Manager </b><br><?=date('d-m-Y',strtotime($maindata['FM_action_date']))?></td>
			<?php } ?>
