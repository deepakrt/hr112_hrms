...
class StoreMaterialPurchaseRequestItem extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['req_id','emp_id', 'item_name', 'id_item', 'item_specification', 'quantity_required', 'approx_cost', 'purpose', 'created_date'], 'required'],
            [['req_id','emp_id','id_item', 'quantity_required', 'approx_cost'], 'integer'],
