...
$e_id = Yii::$app->utility->encryptString($info['e_id']);

//$editUrl = Yii::$app->homeUrl."admin/manageemployees/updateemployee?key=$encry";
$url = Yii::$app->homeUrl."admin/myappraise?securekey=$menuid";
?>
<style>
...
function changeUrl(url) {
	...
	var eid='<?=$e_id;?>';
	var title='';
	url='viewemployee?securekey='+menuid+'&eid='+eid+'&tab='+url;
...
<h3>Personal Information:</h3>
	...
	<div class="col-sm-3">
		...
		<p class="con"><?php if($info['employment_type'] == 'R'){ echo "Regular";}elseif($info['employment_type'] == 'C'){ echo "Contract";}?></p>
	</div>
	<div class="col-sm-3">
...
<?php echo $this->render('employee_qualification', ['qualification'=>$qualification, 'info'=>$info]);?>
</div>
