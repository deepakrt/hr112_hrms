...
//                    echo "<pre>";print_r($checkexits); die;
                    ...
                    if(!empty($checkexits)){
                        ...
                        $html .="<li title='$menu_dsc'><label>$menu_name</label> 
                       <div class='listview'> 
                        ...
                        <button id='hide_$n' type='button' value='N' data-status='$no' data-id='$n' class='btn $hideCls btn-sm btnxs changebtnmenustatus'>Disable</button></div></li>";
                    }else{
                        $html .="<li title='$menu_dsc'><label>$menu_name</label>
                        <div class='listview'> 
                        <input type='hidden' name='Assign[menu][$i][id]' value='$mapid' />
