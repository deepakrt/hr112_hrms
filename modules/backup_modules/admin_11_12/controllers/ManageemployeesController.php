...
//            die("asaaa");
            ...
            $result = Yii::$app->utility->update_employee($employee_code,$email,$fname, $lname, $name_hindi, $gender, $dob, $contact, $emergency_contact, $address, $city, $state, $zip, $contact1, $p_address, $p_city, $p_state, $p_zip, $contact2, $pan_number, $marital_status, $blood_group, $emp_image, $emp_signature);
