...
<div class='row'>
	<div class='col-sm-12'>
		<hr class='hrline'>
		<h6><b>Want to forward this file?</b></h6><br>
...
<div class='row' id='dak_btn_individual_html' style='display:none;'>
	<div class='col-sm-3'>
...
<div class='row' <?=$btnshow?> >
	<div class='col-sm-12 text-center'>
		...
		<button type='submit' class='btn btn-success btn-sm'><?=$submitBtn?></button>
