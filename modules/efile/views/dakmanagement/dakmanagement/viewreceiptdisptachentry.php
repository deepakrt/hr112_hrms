...
?>
<div class="row">
    <div class="col-sm-6" style="text-align:left"><button  class="btn btn-success btn-sm" id="viewdakreceipt">View Dak Receipt</button></div>
    <div class="col-sm-6" style="text-align:right"><button  class="btn btn-primary btn-sm align-right" id="viewdakdispatch">View Dak Dispatch</button></div>
