...
<a style="margin-bottom:10px;" href="<?=Yii::$app->homeUrl?>inventory/supplier/add?securekey=<?=$menuid?>" class="btn btn-success btn-sm mybtn">Add New Supplier</a>	
</div>
</div>
<table id="dataTablefilter" class="display tabledata" cellspacing="0">
	<thead>
		<tr>
			<th>Sr.</th>	
			<th>Supplier Code</th>
