...
<div class='row'>						
 <?= $form->field($model, 'MRN_No')->hiddenInput(['class'=>'form-control form-control-sm'])->label(false) ?>	
...
<legend>Account Details</legend>
    ...
    <div class="form-group">
        ...
        <?php if($sub_btn == "Update/Verify") { ?>
        <?= Html::submitButton('Reject', ['name'=>'Reject','class' => 'btn btn-primary finalrec'])  ?>
    <?php } ?>
    </div>
