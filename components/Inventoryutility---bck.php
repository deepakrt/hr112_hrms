...
class Inventoryutility extends Component {
   ...
   public function get_empname($eid){
    ...
    public function store_get_supplier(){
        $connection=   Yii::$app->db;
        $connection->open();
        $sql =" CALL `store_get_supplier`()";
		$command = $connection->createCommand($sql); 
    ...
    public function add_unit($data){
        ...
        $connection=   Yii::$app->db;
        $connection->open();
        $sql =" CALL `store_item_master`(:Classification_Code,:Item_Cat_Code,:Item_Code,,:item_name
				:Item_Type,:Measuring_Unit,:Quantity_Required,  @Result)";
		$command=$connection->createCommand($sql); 
    ...
    public function add_store_items($data){
		extract($data);
        $connection=   Yii::$app->db;
        $connection->open();
        $sql =" CALL `store_item_master`(:Classification_Code,:Item_Cat_Code,:Item_Code,,:item_name
